...
apt install -y build-essential apache2 php openssl perl make php-gd libgd-dev libapache2-mod-php libperl-dev libssl-dev daemon wget apache2-utils unzip -y

useradd nagios

NAGIOS=nagios-4.4.6.tar.gz

cd ~
wget https://github.com/NagiosEnterprises/nagioscore/archive/$NAGIOS
